...
> **Note**: This repository is a modernized fork of [sonofusion82/j7-c_usb_meter](https://github.com/sonofusion82/j7-c_usb_meter). It has been completely refactored to support **Headless BLE logging** and a **Real-time Web Dashboard** using a modern Python stack (`FastAPI`, `Bleak`, `Typer`, `Rich`).
